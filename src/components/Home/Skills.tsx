...
function Skills() {
  ...
  return (
    ...
    >
      <Typography
        className="uppercase text-center mb-[4vmax] text-[4vmax] text-slate-200"
        variant="h3"
      >
        skills
      </Typography>
      ...
      >
        {skillsCube.map((skill, index) => (
          <div
            key={index}
            className="flex items-center justify-center shadow-[0_0_10px_#000] absolute shadow-gray-700 w-[inherit] h-[inherit] rounded-lg overflow-hidden"
            style={{
      ...
      <div
        className="flex px-[2vmax] flex-col right-[40px] absolute bg-emerald-700 py-5 duration-1000 ease-linear rounded-lg border border-emerald-800 shadow "
        style={{
