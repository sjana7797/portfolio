...
function Header() {
  return (
    <header className="overflow-y-scroll scrollbar-hide lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
      <div className="relative">
        ...
        <TypeAnimation
          ...
          wrapper="h3"
          className="select-none text-3xl font-medium text-cyan-500 sm:text-2xl"
          cursor={true}
          repeat={Infinity}
          speed={20}
          deletionSpeed={10}
